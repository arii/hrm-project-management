...
const AnalysisCard: React.FC<AnalysisCardProps> = ({ title, status, result, onAnalyze, description, repoName, disabled, modelUsed }) => {
        ...
        {result && (
          <div className="space-y-4">
            ...
            <div className="flex justify-end">
              <span className="text-xs text-slate-500 uppercase tracking-wider flex items-center gap-1.5 font-mono">
                <Bot className="w-3.5 h-3.5 text-primary" /> Generated by {modelUsed || 'Gemini 1.5 Flash'}
              </span>
            </div>
          </div>
        )}
